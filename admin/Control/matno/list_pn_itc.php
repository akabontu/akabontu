		...
		<table class="table" style="border-collapse: collapse;">
                    <thead>
                        <tr style="height: 40px;">
                            <th style="width: 40px; text-align:center; padding: 8px 5px;">
#</th>
                            <th style="width: 60px; text-align:center; padding: 8px 5px;">No</th>
                            <th style="width: 170px; text-align:center; padding: 8px 5px;">Part Number</th>
                            <th style="width: 220px; text-align:left; padding: 8px 5px;">Description</th>
